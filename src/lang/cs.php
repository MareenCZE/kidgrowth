...
return array(
    ...
    'label_father_height' => 'Výška otce (cm)',
    'label_mother_height' => 'Výška matky (cm)',
    ...
    'note_target_height' => 'Jen z výšek rodičů ({father} a {mother} cm), bez ohledu na naměřené hodnoty. Pásmo je široké zhruba 17 cm, takže jde spíš o kontrolu než o předpověď. V grafu hnědě.',
    ...
    'unit_cm_per_year' => 'cm/rok',
    'unit_year_short' => 'rok',
    'note_velocity_table' => 'Rychlost růstu je přepočtena na rok a měřena zhruba za poslední rok, ne od předchozího měření – najeďte na hodnotu a uvidíte přesné období. Krátký odstup by chybu měření zvětšil spolu s růstem: půl centimetru nepřesnosti za čtyři měsíce vyjde jako 1,5 cm/rok navíc, takže by i rovnoměrně rostoucí dítě zdánlivě zrychlovalo a zpomalovalo.',
    ...
    'chart_label_projection' => 'Předpověď podle naměřených hodnot: {mid} cm v 18 letech · rozmezí {low}–{high} cm · pásmo {z} SD · z posledních {n} měření',
    'chart_label_target' => 'Cílová (genetická) výška: {mid} cm · rozmezí {low}–{high} cm · jen z výšek rodičů',
    'tooltip_percentile' => '{n}. percentil',
    'tooltip_age' => 'věk {age}',
    'tooltip_height' => 'výška {height} cm',
