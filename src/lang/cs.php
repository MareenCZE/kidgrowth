...
return array(
    ...
    'page_title_import_rustcz' => 'Import z RůstCZ',
    'heading_import_rustcz' => 'Import z RůstCZ',
    'demo_import_disabled' => 'V této ukázce je import vypnutý.',
    'rcz_label_files' => 'Oba soubory ze zálohy',
    'rcz_button_read' => 'Načíst soubory',
    'rcz_button_confirm' => 'Importovat vybrané děti',
    'rcz_where_heading' => 'Kde je vzít',
    'rcz_where_intro' => 'V RůstCZ udělejte zálohu. Vzniknou dva soubory, <code>peda.rcz</code> a <code>meda.rcz</code> &ndash; v jednom jsou děti, ve druhém jejich měření. Vyberte tady oba; co je co se pozná ze souborů samotných, na pořadí nezáleží.',
    'rcz_where_note' => 'Nic se nezapíše, dokud neuvidíte, co v souborech je, a nepotvrdíte to. Samotná záloha se jen čte, nijak se nemění.',
    'rcz_found_heading' => 'Co je v záloze',
    'rcz_found_intro' => 'Každé měření v záloze říká, kterému dítěti patří, takže tady se nic neodhaduje. Zkontrolujte to, případně změňte jméno, a importujte.',
    'rcz_found_note' => 'Opakovaný import téže zálohy nic nezduplikuje: dítě se páruje podle jména a měření podle data.',
    'rcz_column_import' => 'Importovat',
    'rcz_column_parents' => 'Otec / matka',
    'rcz_column_measurements' => 'Měření',
    'rcz_count_mismatch' => '(soubor uvádí {stated})',
    'rcz_orphans' => '{n} měření nepatří žádnému dítěti z tohoto souboru. Soubory možná pocházejí z různých záloh.',
    'rcz_error_need_both' => 'Potřeba jsou oba soubory: jeden s dětmi a jeden s měřeními. Vyberte peda.rcz a meda.rcz najednou.',
    'rcz_error_no_children' => 'Z toho souboru se nepodařilo přečíst žádné dítě.',
    'rcz_error_not_child_file' => 'Tohle není soubor RůstCZ s dětmi: {bytes} bajtů není celý počet {size}bajtových záznamů.',
    'rcz_error_not_measurement_file' => 'Tohle není soubor RůstCZ s měřeními: {bytes} bajtů není celý počet {size}bajtových záznamů.',
    'rcz_error_bad_child_record' => 'Záznam dítěte {n} se nepodařilo přečíst a byl vynechán.',
    'rcz_error_lost_payload' => 'Seznam se mezi dvěma kroky ztratil. Nahrajte soubory prosím znovu.',
    'rcz_error_nothing_selected' => 'Nebylo vybráno nic k importu.',
    'rcz_unnamed_child' => 'Dítě {n}',
