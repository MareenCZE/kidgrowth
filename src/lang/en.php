...
return array(
    ...
    'import_error_invalid_flag' => 'Row {line}: {column} must be 1 or 0 (yes/no).',
    'import_error_child_conflict' => 'Row {line}: {column} for {child} does not match the first row for that child; the first row was used.',
    ...
    'page_title_import_rustcz' => 'Import from RůstCZ',
    'heading_import_rustcz' => 'Import from RůstCZ',
    'demo_import_disabled' => 'Importing is disabled in this demo.',
    'rcz_label_files' => 'Both files from the backup',
    'rcz_button_read' => 'Read the files',
    'rcz_button_confirm' => 'Import the selected children',
    'rcz_where_heading' => 'Where to find them',
    'rcz_where_intro' => 'Take a backup in RůstCZ. It writes two files, <code>peda.rcz</code> and <code>meda.rcz</code> — one holds the children, the other their measurements. Select both here; which is which is worked out from the files themselves, so the order does not matter.',
    'rcz_where_note' => 'Nothing is written until you have seen what the files contain and said so. The backup itself is only read, never changed.',
    'rcz_found_heading' => 'What the backup holds',
    'rcz_found_intro' => 'Each measurement in the backup names the child it belongs to, so none of this is guesswork. Check it, change any name you would rather have different, and import.',
    'rcz_found_note' => 'Importing the same backup twice does not duplicate anything: a child is matched by name and a measurement by its date.',
    'rcz_column_import' => 'Import',
    'rcz_column_parents' => 'Father / mother',
    'rcz_column_measurements' => 'Measurements',
    'rcz_count_mismatch' => '(the file says {stated})',
    'rcz_orphans' => '{n} measurement(s) belong to no child in this file. The two files may be from different backups.',
    'rcz_error_need_both' => 'Both files are needed: one of children and one of measurements. Select peda.rcz and meda.rcz together.',
    'rcz_error_no_children' => 'No child could be read from that file.',
    'rcz_error_not_child_file' => 'That is not the RůstCZ file of children: {bytes} bytes is not a whole number of {size}-byte records.',
    'rcz_error_not_measurement_file' => 'That is not the RůstCZ file of measurements: {bytes} bytes is not a whole number of {size}-byte records.',
    'rcz_error_bad_child_record' => 'Child record {n} could not be read and was left out.',
    'rcz_error_lost_payload' => 'The list was lost between the two steps. Please upload the files again.',
    'rcz_error_nothing_selected' => 'Nothing was selected to import.',
    'rcz_unnamed_child' => 'Child {n}',
