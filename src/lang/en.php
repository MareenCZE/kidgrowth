...
return array(
    ...
    'label_father_height' => "Father's height (cm)",
    'label_mother_height' => "Mother's height (cm)",
    ...
    'note_target_height' => "From the parents' heights alone ({father} and {mother} cm), regardless of measured values. The band is about 17 cm wide, so it is more of a sanity check than a prediction. Shown in brown on the chart.",
    ...
    'chart_label_projection' => 'Prediction from measured values: {mid} cm at 18 years · range {low}–{high} cm · channel {z} SD · from the last {n} measurements',
    'chart_label_target' => "Target (genetic) height: {mid} cm · range {low}–{high} cm · from parents' heights only",
    'tooltip_percentile' => 'percentile {n}',
    'tooltip_age' => 'age {age}',
    'tooltip_height' => 'height {height} cm',
